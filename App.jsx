...
export default function App() { const [lang, setLang] = useState(“en”);
const [viewProduct, setViewProduct] = useState(null); const
[showCheckout, setShowCheckout] = useState(false); const [cart, setCart]
= useState([]);

const t = { viewDetails: lang === “en” ? “View Details” :
“အသေးစိတ်ကြည့်မည်”, addToCart: lang === “en” ? “Add to Cart” :
“ကားထဲထည့်မည်”, cart: lang === “en” ? “Your Cart” : “ဈေးထုပ်”, tagline:
lang === “en” ? “Best price, best quality” : “အကောင်းဆုံးဈေးနှုန်းနဲ့
အရည်အသွေး”, };

const products = [ { id: 1, title: “PS5 Controller”, title_my: “PS5
ခလုတ်”, description: “Brand new original PS5 Controller”,
description_my: “PS5 မူလ ခလုတ်အသစ်”, price: 85, img:
“https://i.imgur.com/7yUVEeD.jpeg”, }, { id: 2, title: “Gaming
Keyboard”, title_my: “ဂယ်မင်း ကီးဘုတ်”, description: “RGB Mechanical
Keyboard”, description_my: “RGB မီကန်နစ်ကယ် ကီးဘုတ်”, price: 45, img:
“https://i.imgur.com/wt6dB9P.jpeg”, }, ];
